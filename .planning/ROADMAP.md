...
- [ ] **Phase 1: Frontend Scaffold & Local Dev** - Vite + React 19 app running locally, tRPC client wired, `netlify dev` proxy confirmed
...
|-------|----------------|--------|-----------|
| 1. Frontend Scaffold & Local Dev | 0/TBD | Not started | - |
